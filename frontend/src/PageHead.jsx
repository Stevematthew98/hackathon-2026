      ...
      <div className="g-pages" aria-label="Prototype pages">
        {[1, 2, 3, 4, 5].map((n) => (
          <button
            ...
            disabled={n > 3}
            onClick={() => n <= 3 && onNav(n)}
            title={n === 1 ? 'Page 1 · The Case Builds Itself' : n === 2 ? 'Page 2 · Forward-to-Check' : n === 3 ? 'Page 3 · The Evidence Graph' : `Page ${n} · coming next`}
            aria-label={n === 1 ? 'Go to page 1' : n === 2 ? 'Go to page 2' : n === 3 ? 'Go to page 3' : `Page ${n}, coming next`}
          />
        ))}
